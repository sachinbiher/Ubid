...
if ( ! function_exists( 'arileextra_consultstreet_frontpage_sections' ) ) :
	...
	$activate_theme = $activate_theme_data->name;		
		...
		if('ConsultStreet' == $activate_theme || 'AssentPress' == $activate_theme || 'Beauty Spa Salon' == $activate_theme || 'Decorexo' == $activate_theme || $activate_theme == 'EnvoPress' || $activate_theme == 'MadisonBlog' || $activate_theme == 'Business Stock' || 'BlogWar' == $activate_theme || 'ConsultGrowth' == $activate_theme){
		require arile_extra_plugin_dir . 'inc/consultstreet/front-page/extra-consultstreet-testimonial.php';
		}
		if('BrightPress' == $activate_theme || $activate_theme == 'FitnessBase' || $activate_theme == 'Arvada' || $activate_theme == 'EarnPress' || $activate_theme == 'ConsultZone' || $activate_theme == 'ConsultHub' || $activate_theme == 'ConsultGuide'){
