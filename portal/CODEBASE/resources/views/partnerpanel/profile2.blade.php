            ...
            <div class="card ">
                ...
                <div class="card-body ">
                    <div class="row dynamic-details">
                        <div class="col-lg-10 col-md-10" style='font-size:15px;'> @if($vendor->status == 1) <p class="text-success">Profile Approved : @php echo date('d M, Y',strtotime($vendor->actiondate)); @endphp</p> @elseif($vendor->status == 3) <p class="text-warning">Profile Not Activated, On Hold : {{$vendor->hold_message}} </p> @elseif($vendor->status == 0) <p class="text-danger">Profile Not Activated : Status Pending</p> @endif </div>
                                                        ...
                                                        <div class="dropdown-divider"></div>
                                                            ...
                                                            <div class="remove-icon">
                                                                <button class="dropdown-item">
                                                                    <i class="mr-50" data-feather="trash" id="{{$projects->id.','.$i}}" onclick="deleteprojectimg(this)"></i> Delete </button>
                                                            </div>
...
<div class="modal fade text-left" id="editProfile" tabindex="-1" aria-labelledby="myModalLabel1" aria-hidden="true">
    <div class="modal-dialog modal-md modal-dialog-centered" role="document">
        <div class="modal-content file-manager-application">
            ...
            <form class="form form-horizontal " id="basic-save" method="post" action="{{route('ppanel.updatebasicdetail')}}" enctype="multipart/form-data"> {!! csrf_field() !!} <div class="modal-body ">
                    <div class="row">
                        <div class="col-12">
                            <div class="profile-picture mx-auto mb-2">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-Success waves-effect waves-float waves-light" name="savebasic" id="savebasic" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Processing..."> Update </button>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content file-manager-application">
            ...
            <form class="form form-horizontal " id="addi-save" method="post" action="{{route('ppanel.updateadditionaldetail')}}" enctype="multipart/form-data"> {!! csrf_field() !!} <div class="modal-body ">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-Success waves-effect waves-float waves-light" name="saveaddi" id="saveaddi" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Processing..."> Update </button>
                </div>
            </form>
        </div>
    </div>
