				...
				<div class="card-body">
					<div class="row my-2">
						...
						<div class="col-12">
							...
							<!-- <div class='row'>
								<div class="card-text col-md-3"><b>Property Type:</b> {{$requirements->property_type}}</div>	
								<div class="card-text col-md-3"> <b>How Early They want? :</b> {{$requirements->how_early}} </div>
								
								<div class="card-text col-md-3"><b>Finish Type:</b> {{$requirements->finish_type}}</div>	
								<div class="card-text col-md-3"> <b>Work Type :</b> {{$requirements->work_type}} </div>
							</div>
							<div class='row'>
								<div class="card-text col-md-3"><b>Total Area: </b> {{$requirements->total_area}} sqft.</div>	
								<div class="card-text col-md-3"> <b>Is Customer Negotiable :</b> {{$requirements->negotiable}} </div>
								<div class="card-text col-md-3"><b>Wanted 2D Designs : </b> {{$requirements->designs_2d}} </div>	
								<div class="card-text col-md-3"><b>Wanted 3D Designs :  </b> {{$requirements->designs_3d}} </div>	
							</div> -->
						</div>
						<div class="col-12">
							<hr />
						...
						<div class="col-12">
							...
							<div class="col-12">
							<h4 class="font-weight-bolder">Bid Details</h4>
							<br />

							<div class="row">
							
	
								@php $vendor_bids = App\Models\Vendor_Bids::where(['requirement_id'=>$requirements->id,'vendor_id'=>$vendor->id])->get(); @endphp
								@php $i=1; @endphp
								@foreach($vendor_bids as $bids)
								...
								<div class="col-md-3">
									...
									@endif
										<h6 class="card-header font-weight-bolder">Bid {{$i}}</h6>
										<div class="card-body">
											<blockquote class="blockquote mb-0">
												<p class="text-center font-weight-bolder mb-0">₹ {{$bids->cost}}</p>
												<p class="text-center font-12">Time - {{date('d M, Y H:m A', strtotime($bids->created_at))}}</p>
