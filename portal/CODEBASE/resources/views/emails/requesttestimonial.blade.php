...
<html lang="en">
                            ...
                            <tbody>
                                <tr>
                                    <td class="td" style="width: 600px; min-width: 600px; font-size: 0pt; line-height: 0pt; padding: 0; margin: 0; font-weight: normal;">
                                                                                ...
                                                                                <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; margin: 0 auto; max-width: 750px; width: 750px;">
                                                                                    <div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 750px;">
                                                                                        ...
                                                                                        <tr>
                                                                                                <div style="text-align: center; padding: 0px; color: #fff;">
                                                                                                    <img
                                                                                                        style="width: 425px; margin-bottom: 0px;"
                                                                                                        src="http://13.126.160.234/ubid/app-assets/mail-assets/images/undraw_message_sent_1030.png"
                                                                                                    />
                                                                                                    <h3 style="text-align: center; color: #47536b; font-size: 17px; text-transform: uppercase; text-decoration: underline;"></h3>
                                                                                                </div>
                                                                                            </tr>
                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="background-body" style="background: #a06942; padding-bottom: 2px;">
                                            <tbody>
                                                <tr>
                                                    <td class="es-p30t es-p30b">
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="py-50 px-50 mpy-30 mpx-20" style="padding-top: 0px; padding-bottom: 35px; padding-left: 50px; padding-right: 50px;">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        "
                                                                                    >
                                                                                    {{$data['name']}} has requested your testimonial!
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
    ...
    font-weight: 400;
                                                                                        "
                                                                                    >
                                                                                    One of our Creative Business Partner- {{$data['name']}} has requested you to rate and give your valuable feedback. This will mean a lot to him/her in this new endeavour!
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
    ...
    font-weight: 400;
                                                                                        "
                                                                                    >
                                                                                    It will hardly take a couple of minutes for you to do so!
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
    ...
    font-weight: 400;
                                                                                        "
                                                                                    >
                                                                                    Please click on the <a href= "{{route('clienttestimonial',['ref_id'=> $data['testimonialid']])}}" >Feedback form</a>  and submit your rating & review.
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
                                                                                                    ...
                                                                                                    >
                                                                                                        ...
                                                                                                        <div class="">
                                                                                                            <ul class="contact-details">
                                                                                                                <li>
                                                                                                                    <a href="https://www.instagram.com/ubidindia/">
                                                                                                                        <img
                                                                                                                            src="http://13.126.160.234/ubid/app-assets/mail-assets/images/instagram.png"
                                                                                                                            width="25px"
                                                                                                                            alt=""
                                                                                                                ...
                                                                                                                <li>
                                                                                                                    <a href="https://www.facebook.com/ubidindia/">
                                                                                                                        <img
                                                                                                                            src="http://13.126.160.234/ubid/app-assets/mail-assets/images/facebook.png"
                                                                                                                            width="25px"
                                                                                                                            alt=""
                                                                                                                            style="padding: 6px; width: 35px;"
                                                                                                                        />
                                                                                                                ...
                                                                                                                <li>
                                                                                                                    <a href="https://twitter.com/UBIDIndia">
                                                                                                                        <img
                                                                                                                            src="http://13.126.160.234/ubid/app-assets/mail-assets/images/twitter.png"
                                                                                                                            width="25px"
                                                                                                                            alt=""
                                                                                                                            style="padding: 6px; width: 35px;"
                                                                                                                        />
