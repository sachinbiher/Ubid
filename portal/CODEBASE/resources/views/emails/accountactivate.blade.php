...
<html lang="en">
    ...
    font-weight: 400;
                                                                                        "
                                                                                    >
                                                                                    You will now be able to Login, place bids and contact<br>customers! Also, get notified
                whenever someone tries to <br>
                message you or show interest on your profile!  <br>
                <a href="{{route('login')}}"><button style="background: #2eeab7;color:#000 !important;margin-top:5px !important" class="visit-sitelink">Log In <span class="arrow"></span></button></a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="center">
