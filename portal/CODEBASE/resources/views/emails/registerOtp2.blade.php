...
<html lang="en">
    ...
    font-weight: 400;
                                                                                        "
                                                                                    >
                                                                                    One of our Creative Business Partner- {{$data['name']}} has requested you to rate and give your valuable feedback. This will mean a lot to him in this new endeavour!
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
    ...
    font-weight: 400;
                                                                                        "
                                                                                    >
                                                                                    Please click on the <a href= "{{route('clienttestimonial',['vendor_id'=>$vendorid])}}" >Feedback form</a>  and submit your rating & review.
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td
                                                                                ...
                                                                                <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; margin: 0 auto; max-width: 750px; width: 750px;">
                                                                                    <div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 750px;">
                                                                                        ...
                                                                                        >
                                                                                            <tr>
                                                                                                <div style="text-align: center; padding: 0px; color: #fff;">
                                                                                                    <button href="https://www.ubidindia.com/" class="visit-sitelink">Visit Website <span class="arrow"></span></button>
                                                                                                </div>
                                                                                            </tr>
                                                                                        </table>
                                                                                    </div>
