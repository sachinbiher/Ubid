...
<body>
                                                                            ...
                                                                            <td class="container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; display: block; Margin: 0 auto; max-width: 750px; width: 750px;">
                                                                                <div class="content" style="box-sizing: border-box; display: block; Margin: 0 auto; max-width: 750px;">
                                                                                    <table class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: auto;margin:0 auto;padding:12px 12px; background: #ffffff; border-radius: 3px;">
                                                                                        <tr>
                                                                                            <div style="  text-align: center; padding: 0px; color: #fff;">
                                                                                                <img style="width:425px; margin-bottom: 0px;" src="http://13.126.160.234/ubid/app-assets/mail-assets/images/undraw_forgot_password_gi2d.png" />
                                                                                                <h3 style="text-align: center; color:#47536b; font-size: 17px; text-transform: uppercase; text-decoration: underline;"></h3>
                                                                                            </div>
                                                                                        </tr>
                                                                                    </table>
 ...
 padding-left: 50px; padding-right: 50px;">
                                                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="text-14 t-color a-center pb-18 tt-u fw-b" style="font-family:'Montserrat', Arial, sans-serif; font-size:31px; line-height:24px; min-width:auto !important; color:#e75e83; text-align:center; padding-bottom: 18px; font-weight:400;color:#2b2929">Forgot Password?  </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="text-14 t-color a-center pb-18 tt-u fw-b" style="font-family:'Montserrat', Arial, sans-serif; font-size:17px; line-height:31px; min-width:auto !important; color:#e75e83; text-align:center; padding-bottom: 18px; font-weight:400;color:#2b2929"> This happens with all of us! Just enter your registered email ID and we will share the link to reset password  </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td class="text-14 t-color a-center pb-18 tt-u fw-b" style="font-family:'Montserrat', Arial, sans-serif; font-size:25px; line-height:24px; min-width:auto !important; color:#e75e83; text-align:center; padding-bottom: 18px; font-weight:400;color:#2b2929"> New Password </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="center">
                                                                                    <!-- Button -->
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td class="text-btn btn-1" style="mso-padding-alt:14px 20px; font-family:'Montserrat', Arial, sans-serif; font-size:14px; line-height:18px; text-align:center; font-weight:bold; border-radius:3px; min-width:auto !important;">
                                                                                                    <a href="#" target="_blank" class="link btn-1-c" style="padding: 14px 20px; display: block; text-decoration:none; color:#ffffff; font-size: 26px;"><span class="link btn-1-c" style="text-decoration:none;    color: #fff;
    background: #945e37;
    letter-spacing: 0.1px;
    font-weight: 500;
    padding: 8px 13px;
    border-radius: 24px;
    font-size: 19px;">{{$password}}</span></a>
                                                                                                </td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
