...
(function (window, document, $) {
  ...
  var  variantdescriptionEditor = new Quill('#variant-description-container .editor', {
    bounds: '#variant-description-container .editor',
    modules: {
      formula: true,
      syntax: true,
      toolbar: [
  ...
  var editors = [bubbleEditor, snowEditor, fullEditor,variantdescriptionEditor];
