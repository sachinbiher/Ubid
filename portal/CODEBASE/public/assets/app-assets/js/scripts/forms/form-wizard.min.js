$((function() {
    ...
    if (n.each((function() {
        ...
        // });
            ...
            tagSelect.wrap('<div class="position-relative"></div>'), tagSelect.select2({
                // placeholder: "Select value",
            ...
            var SelectAttributes = $('.checbox-select')
            SelectAttributes.wrap('<div class="position-relative"></div>'), SelectAttributes.select2({
                closeOnSelect : false,
